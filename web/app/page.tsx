      ...
      >
        ...
        <main className="mx-auto max-w-6xl px-4 pb-20">
          ...
          <LessonSection title="Welcome, Future Network Engineer! 👋" isIntro>
            ...
            <h2 className="mt-12 mb-8 text-3xl font-bold text-white">
              What You'll Master
            </h2>
          ...
          <LessonSection title="Navigating Between Modes">
            ...
            <h2 className="mt-10 mb-4 text-2xl font-bold text-blue-400">Understanding the Prompt</h2>
            <p className="mb-6 text-gray-300">The prompt (the text before where you type) tells you where you are:</p>
            ...
            <div className="my-6 space-y-3">
              <div className="flex flex-col items-start gap-3 rounded-lg border border-gray-700 bg-gray-800 p-4 sm:flex-row sm:items-center">
                <code className="w-full rounded bg-gray-900 px-3 py-2 font-mono text-blue-400 sm:w-auto sm:min-w-[180px]">Switch&gt;</code>
              ...
              <div className="flex flex-col items-start gap-3 rounded-lg border border-gray-700 bg-gray-800 p-4 sm:flex-row sm:items-center">
                <code className="w-full rounded bg-gray-900 px-3 py-2 font-mono text-blue-400 sm:w-auto sm:min-w-[180px]">Switch(config)#</code>
                <span className="text-sm text-gray-400">Configuration mode — Where you make changes</span>
              </div>
            </div>

            <h2 className="mt-12 mb-4 text-2xl font-bold text-blue-400">Moving Between Modes</h2>
            <p className="mb-6 text-gray-300">
            ...
            <div className="my-6 space-y-3">
              <div className="rounded-lg border border-gray-700 bg-gray-800 p-4">
                ...
                <p className="mt-2 text-sm text-gray-400">Moves from user mode (<code>&gt;</code>) to privileged mode (<code>#</code>)</p>
              </div>
              <div className="rounded-lg border border-gray-700 bg-gray-800 p-4">
                <code className="font-mono text-blue-400">configure terminal</code>
                <p className="mt-2 text-sm text-gray-400">Moves from privileged mode (<code>#</code>) to configuration mode (<code>(config)#</code>)</p>
              </div>
              <div className="rounded-lg border border-gray-700 bg-gray-800 p-4">
            ...
            <InfoBox variant="important">
              <p className="mb-3 font-semibold text-yellow-200">⚠️ About CNTL/Z in Simulators</p>
            ...
            <div className="my-6 grid gap-4 md:grid-cols-2">
              <div className="rounded-lg border border-blue-600 bg-gray-800 p-4">
                <h4 className="mb-3 text-sm font-semibold text-blue-300">Using exit (Step by step)</h4>
              ...
              <div className="rounded-lg border border-green-600 bg-gray-800 p-4">
                <h4 className="mb-3 text-sm font-semibold text-green-300">Using end (Recommended ✓)</h4>
                <div className="space-y-1 font-mono text-sm text-gray-300">
            ...
            <p className="mb-8 text-lg text-gray-300">Practice moving between modes in the terminal below:</p>
          ...
          <LessonSection title="The Magic TAB Key ✨">
            ...
            <div className="my-8 space-y-4">
              <div className="rounded-lg border border-gray-700 bg-gray-800 p-6">
                <h4 className="mb-3 text-lg font-semibold text-white">1. Auto-Completes Commands</h4>
                <p className="mb-3 text-gray-300">Type part of a command and press <kbd>TAB</kbd> to complete it automatically.</p>
                <div className="mt-3 rounded bg-gray-900 p-4">
                  ...
                  <p className="mt-2 text-gray-400">→ Completes to: <code className="text-blue-400">configure</code></p>
                </div>
              </div>
              <div className="rounded-lg border border-gray-700 bg-gray-800 p-6">
                <h4 className="mb-3 text-lg font-semibold text-white">2. Shows Available Options</h4>
                <p className="mb-3 text-gray-300">If multiple commands match, pressing <kbd>TAB</kbd> twice shows all options.</p>
                <div className="mt-3 rounded bg-gray-900 p-4">
                  <p className="mb-2 text-gray-400">Example:</p>
                  <p className="font-mono text-green-400">Switch# sh{'<TAB><TAB>'}</p>
                  <p className="mt-2 text-gray-400">→ Shows: <code className="text-blue-400">show</code>, <code className="text-blue-400">shutdown</code>, etc.</p>
                </div>
              </div>
            </div>
            ...
            <InfoBox variant="info">
              <ProTip>
                <p className="mb-2 text-gray-300">Press <kbd>TAB</kbd> at any time to auto-complete commands or see options!</p>
                <p className="text-gray-300">This is the #1 trick professionals use. It prevents typos and speeds you up.</p>
              </ProTip>
            </InfoBox>

            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">What If TAB Doesn't Do Anything?</h2>
            <p className="mb-6 text-lg text-gray-300">
            ...
            <div className="my-8 rounded-lg border border-gray-700 bg-gray-900 p-6">
              ...
              <p className="mb-4 text-gray-400">Let's say you forgot to type <code>enable</code> first:</p>
              ...
              <div className="mt-6 rounded bg-black p-4 font-mono">
                ...
                <p className="mt-1 text-green-400">Switch# conf<span className="text-gray-500">&lt;TAB&gt;</span></p>
                <p className="mt-1 text-blue-400">Switch# configure <span className="text-gray-500">← Now it works!</span></p>
              </div>
            </div>
            ...
            <p className="mb-8 text-lg text-gray-300">Practice using TAB completion in the terminal below:</p>
            <ol className="my-8 list-decimal space-y-5 rounded-lg border border-gray-700 bg-gray-800 p-8 pl-12 text-gray-300">
          ...
          <LessonSection title="Understanding Paginated Output 📄">
            ...
            <div className="my-8 rounded-lg border border-gray-700 bg-gray-900 p-6">
              <p className="mb-4 font-semibold text-gray-400">Example: Running a long command</p>
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Controlling Pagination</h2>
            <p className="mb-6 text-lg text-gray-300">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Your First Paginated Command</h2>
            <p className="mb-6 text-lg text-gray-300">
            ...
            <InfoBox variant="success">
              <div className="text-gray-300">
                <p className="mb-3 text-lg font-semibold text-green-400">✓ You succeeded when:</p>
...
└──────────────────────┘`}
            ...
            <InfoBox variant="important">
              ...
              <p className="mb-3 text-gray-200">Changes in Cisco IOS are NOT saved automatically!</p>
...
% Name lookup aborted`}
            ...
            <div className="my-8 rounded-lg border border-blue-600 bg-blue-900 p-6">
              <h4 className="mb-3 text-lg font-semibold text-blue-300">Why Does This Happen?</h4>
              <p className="mb-4 text-gray-300">
            ...
            <h2 className="mt-16 mb-6 text-3xl font-bold text-green-400">The Escape Sequence: CTRL+SHIFT+6</h2>
            <p className="mb-6 text-lg text-gray-300">
            ...
            <div className="my-8 rounded-lg border-2 border-green-500 bg-green-900 p-8">
              <div className="mb-6 text-center">
                <p className="mb-4 text-2xl font-bold text-green-200">Press these keys together:</p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <code className="text-sm text-red-400">Translating "end"...domain server (255.255.255.255)</code>
                  </div>
                </div>
                <div className="flex items-start gap-4">
          ...
          <LessonSection title="Security: Adding a Password">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Why Passwords Matter</h2>
            <p className="mb-4 text-gray-300">Imagine if anyone could reconfigure your school's network. They could:</p>
    ...
    (Protected)`}
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Password Best Practices</h2>
          ...
          <LessonSection title="Understanding Password Entry in IOS">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">The Big Surprise: You Won't See Anything!</h2>
            <p className="mb-6 text-gray-300">
            ...
            <div className="my-8 grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border border-gray-700 bg-gray-800 p-6">
                <h4 className="mb-3 font-semibold text-white">Web Password (What you're used to)</h4>
                <Diagram>
                  {`Username: admin
Password: ••••••••
                    ↑
              ...
              <div className="rounded-lg border border-blue-600 bg-blue-900 p-6">
                <h4 className="mb-3 font-semibold text-blue-300">IOS CLI Password (The real thing)</h4>
                <Diagram>
                  {`Switch> enable
Password: 
          ↑
    You see NOTHING!`}
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Why Does IOS Do This?</h2>
...
`}
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">What Happens If You Get It Wrong?</h2>
            <p className="mb-6 text-gray-300">
            ...
            <InfoBox variant="important">
              <p className="mb-3 font-semibold text-yellow-200">⚠️ Important: Understanding Password Attempts</p>
              <p className="mb-3 text-gray-300">
...
Router1(config)# no enable secret`}
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">What Happens When You Use 'no'?</h2>
            <p className="mb-6 text-gray-300">
            ...
            <div className="mb-8 space-y-4">
              ...
              <div className="border-l-4 border-purple-500 bg-gray-800 p-6">
                ...
                <p className="mt-2 text-sm text-gray-400">→ No password required for enable (back to how it was initially)</p>
              </div>
            </div>
          ...
          <LessonSection title="Working with Sub-Configuration Modes">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Understanding Configuration Layers</h2>
            <p className="mb-6 text-gray-300">
            ...
            <div className="my-8 rounded-lg border border-gray-700 bg-gray-900 p-8">
              <h4 className="mb-6 text-center font-semibold text-blue-300">Configuration Layers (Think: Nested Boxes)</h4>
                ...
                <div className="ml-8 rounded-lg border-2 border-green-500 bg-green-950 p-6">
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Layer 2: Global Configuration Mode</p>
                    </div>
                  </div>
                  ...
                  <div className="ml-8 rounded-lg border-2 border-purple-500 bg-purple-950 p-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">Layer 3: Interface Configuration Mode (Deepest!)</p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-6 text-center text-gray-300">
                <span className="font-semibold text-yellow-300">💡 Pro Tip:</span> Use <code>end</code> from anywhere to jump straight to Layer 1!
              </div>
            </div>
   ...
   └─ [Settings] (Global Config)
       └─ [Network Adapter] (Interface Config)
           └─ [IP Address Settings] (You configure here!)`}
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Different Types of Sub-Configuration Modes</h2>
            <p className="mb-6 text-gray-300">
            ...
            <div className="my-8 rounded-lg border border-gray-700 bg-gray-900 p-8">
              <div className="space-y-6">
                <div className="border-l-4 border-purple-500 pl-6">
                  <h4 className="mb-2 font-mono text-lg font-semibold text-purple-300">(config-if)#</h4>
                  <p className="font-semibold text-white">Interface Configuration Mode</p>
                  <p className="mt-2 text-gray-400">For configuring physical or logical interfaces (like g0/1 or vlan 1)</p>
                  <p className="mt-1 text-sm text-gray-500">Example: <code>interface vlan 1</code></p>
                </div>

                <div className="border-l-4 border-blue-500 pl-6">
                  <h4 className="mb-2 font-mono text-lg font-semibold text-blue-300">(config-vlan)#</h4>
                  ...
                  <p className="mt-1 text-sm text-gray-500">Example: <code>vlan 100</code></p>
                </div>

                <div className="border-l-4 border-green-500 pl-6">
                  <h4 className="mb-2 font-mono text-lg font-semibold text-green-300">(config-router)#</h4>
                  <p className="font-semibold text-white">Router Configuration Mode</p>
                  <p className="mt-2 text-gray-400">For configuring routing protocols like OSPF</p>
                  <p className="mt-1 text-sm text-gray-500">Example: <code>router ospf 1</code></p>
                </div>

                <div className="border-l-4 border-yellow-500 pl-6">
                  <h4 className="mb-2 font-mono text-lg font-semibold text-yellow-300">(config-line)#</h4>
                  <p className="font-semibold text-white">Line Configuration Mode</p>
                  <p className="mt-2 text-gray-400">For configuring console and VTY (remote access) lines</p>
                  <p className="mt-1 text-sm text-gray-500">Example: <code>line console 0</code></p>
                </div>
              </div>
            </div>
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Exit vs End: The Important Difference</h2>
            <p className="mb-4 text-gray-300">
...
Takes 2 exits to get back`}
                ...
                <p className="mt-3 text-gray-400"><strong>Use when:</strong> You want to go back one level</p>
              </div>
              <div className="rounded-lg border border-green-600 bg-green-900 p-6">
...
Takes 1 command! [✓]`}
                ...
                <p className="mt-3 text-gray-400"><strong>Use when:</strong> You want to jump straight to privileged mode</p>
              </div>
            </div>

            <InfoBox variant="info">
              <ProTip>
                <p className="mb-2 text-gray-300">Use <code>end</code> when you're deep in configuration and want to get back to privileged mode quickly!</p>
            ...
            <p className="mb-8 text-lg text-gray-300">Practice navigating different sub-configuration modes:</p>
            <ol className="my-8 list-decimal space-y-5 rounded-lg border border-gray-700 bg-gray-800 p-8 pl-12 text-gray-300">
              <li><code>enable</code> — Enter privileged mode</li>
          ...
          <LessonSection title="Managing Console Messages">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">What Are System Messages?</h2>
            <p className="mb-6 text-gray-300">
...
Switch#`}
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">The Problem: Interrupted Commands</h2>
            <p className="mb-6 text-gray-300">
            ...
            <div className="my-8 grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border border-red-600 bg-red-900 p-6">
                <h4 className="mb-3 font-semibold text-red-300">❌ Without logging synchronous</h4>
                <Diagram>
                  {`Switch#show ru
%SYS-5-CONFIG_I: Configured from console by console
nning-config
              ...
              <div className="rounded-lg border border-green-600 bg-green-900 p-6">
                <h4 className="mb-3 font-semibold text-green-300">✅ With logging synchronous</h4>
                <Diagram>
...
Switch#show running-config
                ...
                <p className="mt-3 text-gray-400">Message appears, but your command stays intact</p>
              </div>
            </div>

            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">The Solution: logging synchronous</h2>
            <p className="mb-6 text-gray-300">
            ...
            <p className="mb-8 text-lg text-gray-300">Configure logging synchronous and observe the difference:</p>
            <ol className="my-8 list-decimal space-y-5 rounded-lg border border-gray-700 bg-gray-800 p-8 pl-12 text-gray-300">
              <li><code>enable</code> — Enter privileged mode</li>
          ...
          <LessonSection title="Understanding IP Addresses">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">What's an IP Address?</h2>
            <p className="mb-6 text-gray-300">Think of an IP address like a phone number or street address:</p>
            ...
            <div className="my-8 rounded-lg border border-gray-700 bg-gray-800 p-8">
              ...
              <div className="mb-6 flex items-center justify-center gap-3">
                <div className="rounded bg-blue-600 px-6 py-4 text-2xl font-bold text-white">192</div>
                <div className="text-2xl text-white">.</div>
                <div className="rounded bg-blue-600 px-6 py-4 text-2xl font-bold text-white">168</div>
                <div className="text-2xl text-white">.</div>
                <div className="rounded bg-blue-600 px-6 py-4 text-2xl font-bold text-white">1</div>
                <div className="text-2xl text-white">.</div>
                <div className="rounded bg-blue-600 px-6 py-4 text-2xl font-bold text-white">100</div>
              </div>
              <p className="mb-4 text-center text-gray-400">Four numbers separated by dots (periods)</p>
            ...
            <h2 className="mt-16 mb-6 text-3xl font-bold text-blue-400">What's a Subnet Mask?</h2>
            <p className="mb-6 text-gray-300">
            ...
            <div className="my-8 rounded-lg border border-gray-700 bg-gray-800 p-8">
              ...
              <div className="mb-6 flex items-center justify-center gap-3">
                <div className="rounded bg-green-600 px-6 py-4 text-2xl font-bold text-white">255</div>
                <div className="text-2xl text-white">.</div>
                <div className="rounded bg-green-600 px-6 py-4 text-2xl font-bold text-white">255</div>
                <div className="text-2xl text-white">.</div>
                <div className="rounded bg-green-600 px-6 py-4 text-2xl font-bold text-white">255</div>
                <div className="text-2xl text-white">.</div>
                <div className="rounded bg-green-600 px-6 py-4 text-2xl font-bold text-white">0</div>
              </div>
              <p className="mb-4 text-center text-gray-400">Also four numbers separated by dots</p>
          ...
          <LessonSection title="Network Hardware: Switches and Interfaces">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">What Does a Switch Look Like?</h2>
            <p className="mb-6 text-gray-300">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">What is an Interface?</h2>
            <p className="mb-6 text-gray-300">
            ...
            <div className="my-8 grid gap-6 md:grid-cols-2">
              ...
              <div className="rounded-lg border border-gray-700 bg-gray-800 p-6">
                ...
                <p className="mt-4 text-xs text-gray-400">The numbers identify which slot and port</p>
              </div>
            </div>

            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">The Console Port: Your First Connection</h2>
            <p className="mb-6 text-gray-300">
            ...
            <InfoBox variant="info">
              <h4 className="mb-3 font-semibold text-blue-300">Why Do We Need a Console Port?</h4>
              <p className="mb-3 text-gray-300">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Summary: The Two Ways to Access a Switch</h2>
            <div className="my-8 grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border border-gray-700 bg-gray-800 p-6">
                ...
                <p className="mt-4 text-gray-400"><strong>Use for:</strong> Initial setup</p>
              </div>
              <div className="rounded-lg border border-gray-700 bg-gray-800 p-6">
                ...
                <p className="mt-4 text-gray-400"><strong>Use for:</strong> Day-to-day management</p>
              </div>
            </div>
          ...
          <LessonSection title="Configuring Management Access">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">What is Management Access?</h2>
            <p className="mb-6 text-gray-300">
...
Manage from anywhere remotely!`}
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">The Management Interface</h2>
            <p className="mb-6 text-gray-300">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">The "no shutdown" Command</h2>
            <p className="mb-6 text-gray-300">
...
no shutdown:         Interface is ON [✓]
            ...
            <p className="mb-8 text-lg text-gray-300">Configure management access on your switch:</p>
            <ol className="my-8 list-decimal space-y-5 rounded-lg border border-gray-700 bg-gray-800 p-8 pl-12 text-gray-300">
            ...
            <div className="my-8 rounded-lg border border-green-600 bg-green-900 p-6">
              ...
              <p className="mb-2 text-gray-300">Type: <code>show ip interface brief</code></p>
...
└──────────────────────────────────────────────┘`}
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Why Do VLANs Need IP Addresses?</h2>
            <p className="mb-4 text-gray-300">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">SVI vs Management Interface</h2>
            <p className="mb-6 text-gray-300">
...
Purpose: Gateway for computers in VLAN 100`}
            ...
            <InfoBox variant="important">
              <p className="mb-2 font-semibold text-yellow-200">🎯 Key Concept: Default Gateway</p>
              <p className="text-gray-300">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Enable Routing on Layer 3 Switches</h2>
            <p className="mb-6 text-gray-300">
            ...
            <div className="my-8 rounded-lg border border-gray-700 bg-gray-800 p-6">
              ...
              <p className="mt-2 text-gray-400">This command tells the switch: "Start routing packets between VLANs!"</p>
            </div>

            <h3 className="mt-16 mb-6 flex items-center gap-3 text-3xl font-bold text-blue-400">
              <span className="text-4xl">👉</span> Your Task
            </h3>
            <p className="mb-8 text-lg text-gray-300">Configure SVIs for inter-VLAN routing on a Layer 3 switch:</p>
            <ol className="my-8 list-decimal space-y-5 rounded-lg border border-gray-700 bg-gray-800 p-8 pl-12 text-gray-300">
              <li><code>enable</code></li>
              <li><code>configure terminal</code></li>
          ...
          <LessonSection title="Trunk Ports: Connecting Switches">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Access Port vs Trunk Port</h2>

            <div className="my-8 grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border border-gray-700 bg-gray-800 p-6">
                <h4 className="mb-3 font-semibold text-white">Access Port</h4>
                <p className="mb-3 text-gray-300">Carries <strong>ONE</strong> VLAN</p>
                <Diagram>
 ...
 VLAN 100       (Only VLAN 100)`}
              ...
              <div className="rounded-lg border border-gray-700 bg-gray-800 p-6">
                ...
                <p className="mb-3 text-gray-300">Carries <strong>MULTIPLE</strong> VLANs</p>
                <Diagram>
   ...
   VLAN 200 ═══════════════ VLAN 200`}
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Two Types of Trunk Configuration</h2>
            <p className="mb-6 text-gray-300">
            ...
            <div className="my-8 grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border border-green-600 bg-green-900 p-6">
                <h4 className="mb-3 font-semibold text-green-300">✅ Allow ALL VLANs (Default)</h4>
                <Diagram>
                  {`interface fa0/1
...
means ALL VLANs can pass through.`}
                ...
                <p className="mt-3 text-gray-400"><strong>Use when:</strong> You want the trunk to carry everything</p>
              </div>
              <div className="rounded-lg border border-yellow-600 bg-yellow-900 p-6">
                <h4 className="mb-3 font-semibold text-yellow-300">⚠️ Restrict to Specific VLANs</h4>
                <Diagram>
                  {`interface fa0/1
 switchport mode trunk
...
All others are BLOCKED!`}
                ...
                <p className="mt-3 text-gray-400"><strong>Use when:</strong> Security requires limiting VLANs</p>
              </div>
            </div>
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Why Limit Allowed VLANs?</h2>
            <p className="mb-6 text-gray-300">
            ...
            <p className="mb-8 text-lg text-gray-300">First, configure a trunk that allows ALL VLANs (the simple way):</p>
            <ol className="my-8 list-decimal space-y-5 rounded-lg border border-gray-700 bg-gray-800 p-8 pl-12 text-gray-300">
              <li><code>enable</code></li>
              <li><code>configure terminal</code></li>
            ...
            <div className="my-8 rounded-lg border border-green-600 bg-green-900 p-6">
              <p className="mb-3 font-semibold text-green-300">✓ You succeeded when:</p>
              <p className="mb-2 text-gray-300">Type <code>show running-config</code> — you should see:</p>
            ...
            <p className="mb-8 text-lg text-gray-300">Now configure trunk ports that carry only specific VLANs:</p>
            <ol className="my-8 list-decimal space-y-5 rounded-lg border border-gray-700 bg-gray-800 p-8 pl-12 text-gray-300">
              <li><code>enable</code></li>
              <li><code>configure terminal</code></li>
          ...
          <LessonSection title="SSH: Secure Remote Access">
            ...
            <p className="mb-8 text-gray-300">SSH (Secure Shell) makes this possible — with encryption so hackers can't steal passwords.</p>
...
[X] They're in!`}
              ...
              <div className="rounded-lg border border-green-600 bg-green-900 p-6">
                <h4 className="mb-3 font-semibold text-green-300">SSH (Secure Way - ENCRYPTED)</h4>
...
[✓] Can't break in!`}
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">SSH Setup Components</h2>
            <div className="my-8 space-y-4">
            ...
            <p className="mb-8 text-lg text-gray-300">Configure complete SSH access (this is a big one!):</p>
            <ol className="my-8 list-decimal space-y-5 rounded-lg border border-gray-700 bg-gray-800 p-8 pl-12 text-gray-300">
              <li><code>enable</code></li>
              <li><code>configure terminal</code></li>
          ...
          <LessonSection title="Layer 3 Switching: Routed Ports">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Understanding Switch vs Router Ports</h2>
            <p className="mb-6 text-gray-300">
            ...
            <div className="my-8 grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border border-gray-700 bg-gray-800 p-6">
                ...
                <p className="mt-3 text-gray-400"><strong>Used for:</strong> Connecting end devices</p>
              </div>
              <div className="rounded-lg border border-gray-700 bg-gray-800 p-6">
               ...
               Routes packets`}
                ...
                <p className="mt-3 text-gray-400"><strong>Used for:</strong> Connecting to routers</p>
              </div>
            </div>

            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">The Magic: "no switchport"</h2>
            <p className="mb-4 text-gray-300">
...
g1/0/2 = Routed port (connects to router/internet)`}
            ...
            <h2 className="mt-16 mb-6 text-3xl font-bold text-blue-400">Point-to-Point Subnets: The /30 Network</h2>
            <p className="mb-6 text-gray-300">
...
Only 2 devices, so only need 2 IPs!`}
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Understanding /30 Subnets</h2>
            <p className="mb-4 text-gray-300">
            ...
            <div className="my-8 rounded-lg border border-gray-700 bg-gray-800 p-6">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="rounded bg-gray-900 p-4">
                  ...
                  <p className="mt-1 text-xs text-gray-500">Can't use — identifies the network</p>
                </div>
                <div className="rounded bg-gray-900 p-4">
            ...
            <p className="mb-8 text-lg text-gray-300">Configure a routed port on a Layer 3 switch:</p>
            <ol className="my-8 list-decimal space-y-5 rounded-lg border border-gray-700 bg-gray-800 p-8 pl-12 text-gray-300">
              <li><code>enable</code></li>
              <li><code>configure terminal</code></li>
          ...
          <div className="my-24 rounded-xl border-4 border-blue-500 bg-gradient-to-r from-blue-900/30 to-purple-900/30 p-12">
            ...
            <div className="my-8 grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border-2 border-gray-600 bg-gray-800 p-6">
                <h4 className="mb-4 text-xl font-bold text-blue-300">Catalyst 2960 Switch<br/><span className="text-sm text-gray-400">(Lessons 1-13)</span></h4>
                <ul className="space-y-3 text-gray-300">
              ...
              <div className="rounded-lg border-2 border-green-500 bg-gray-800 p-6">
                <h4 className="mb-4 text-xl font-bold text-green-300">Cisco 1941 Router<br/><span className="text-sm text-gray-400">(Lessons 14+)</span></h4>
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start gap-2">
...
- Need "no switchport" for L3`}
            ...
            <div className="mt-8 rounded-lg border border-blue-600 bg-blue-900/40 p-6">
              <h4 className="mb-3 text-lg font-semibold text-blue-300">💡 What This Means For You</h4>
          ...
          <LessonSection title="Static Routing: Directing Traffic">
            ...
            <p className="mt-4 text-gray-300">Routers need the same kind of directions for network traffic!</p>
...
└──────────┘         └───────────┘        └────────────┘
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">What is 0.0.0.0 0.0.0.0?</h2>
            <p className="mb-6 text-gray-300">
            ...
            <InfoBox variant="info">
              ...
              <p className="mt-2 text-gray-300">Means: "For ANY destination we don't have a specific route for, send it to 35.72.13.1"</p>
            </InfoBox>

            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Floating Static Routes: The Backup Plan</h2>
            <p className="mb-6 text-gray-300">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Administrative Distance (AD)</h2>
            <p className="mb-6 text-gray-300">
...
Slower backup connection`}
            ...
            <InfoBox variant="real-world">
              <h4 className="mb-3 font-semibold text-blue-300">🌍 Business Continuity Example</h4>
              <p className="mb-3 text-gray-300">
              ...
              <p className="mt-3 text-gray-300">If fiber fails, cable automatically takes over. If both fail, cellular kicks in!</p>
            </InfoBox>

            <h3 className="mt-16 mb-6 flex items-center gap-3 text-3xl font-bold text-blue-400">
              <span className="text-4xl">👉</span> Your Task
            </h3>
            <p className="mb-8 text-lg text-gray-300">Configure a primary default route with a floating backup:</p>
            <ol className="my-8 list-decimal space-y-5 rounded-lg border border-gray-700 bg-gray-800 p-8 pl-12 text-gray-300">
              <li><code>enable</code></li>
              <li><code>configure terminal</code></li>
            ...
            <div className="my-8 rounded-lg border border-green-600 bg-green-900 p-6">
              ...
              <p className="mt-2 text-gray-300">You should see two default routes (0.0.0.0/0):</p>
              <ul className="mt-2 ml-6 list-disc space-y-1 text-gray-300">
          ...
          <LessonSection title="OSPF: Dynamic Routing Protocol">
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Static vs Dynamic Routing</h2>
            ...
            <div className="my-8 grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border border-red-600 bg-red-900 p-6">
                ...
                <p className="mt-4 text-gray-400"><strong>Best for:</strong> Small networks, backup routes</p>
              </div>
              <div className="rounded-lg border border-green-600 bg-green-900 p-6">
                <h4 className="mb-3 font-semibold text-green-300">✅ Dynamic Routing (Automatic)</h4>
                <ul className="ml-6 list-disc space-y-2 text-gray-300">
                ...
                <p className="mt-4 text-gray-400"><strong>Best for:</strong> Medium to large networks</p>
              </div>
            </div>

            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">What is OSPF?</h2>
            <p className="mb-4 text-lg text-gray-300"><strong className="text-white">OSPF</strong> = Open Shortest Path First</p>
            <ul className="ml-8 list-disc space-y-3 text-gray-300">
...
Traffic flows: A → C → B`}
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Wildcard Masks Explained</h2>
            <p className="mb-6 text-gray-300">
            ...
            <InfoBox variant="info">
              ...
              <p className="mt-3 text-gray-300">In wildcard: <strong className="text-white">0 = must match</strong>, <strong className="text-white">255 = don't care</strong></p>
            </InfoBox>
            ...
            <p className="mb-8 text-lg text-gray-300">Configure OSPF to advertise a single network:</p>
            <ol className="my-8 list-decimal space-y-5 rounded-lg border border-gray-700 bg-gray-800 p-8 pl-12 text-gray-300">
              <li><code>enable</code></li>
              <li><code>configure terminal</code></li>
            ...
            <InfoBox variant="info">
              <ProTip>
                <p className="mb-2 text-gray-300"><code>network 35.72.12.2 0.0.0.0 area 0</code> breaks down to:</p>
                <ul className="ml-6 list-disc space-y-2 text-gray-300">
            ...
            <h2 className="mt-16 mb-6 text-3xl font-bold text-blue-400">OSPF on ALL Layer 3 Interfaces</h2>
            <p className="mb-6 text-gray-300">
...
router ospf 1
 ...
 network 33.2.169.1 0.0.0.0 area 0`}
            ...
            <div className="my-8 rounded-lg border border-green-600 bg-green-900 p-6">
              <p className="mb-3 font-semibold text-green-300">✓ Verify your work:</p>
              <p className="mb-2 text-gray-300">Type: <code>show running-config</code></p>
          ...
          <LessonSection title="OSPF Interface Cost: Path Preference">
            ...
            <p className="mb-4 text-gray-300">OSPF assigns a "cost" to each link based on its bandwidth. Think of cost as:</p>
            <ul className="ml-8 list-disc space-y-2 text-gray-300">
...
OSPF always chooses Path 1 (lowest total cost)`}
            ...
            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Default OSPF Cost Calculation</h2>
            <p className="mb-6 text-gray-300">By default, OSPF calculates cost based on bandwidth:</p>

            <InfoBox variant="info">
              <p className="mb-3 font-semibold text-green-200">Formula: Cost = 100,000,000 / bandwidth in bps</p>
              <ul className="ml-6 space-y-2 text-gray-300">
              ...
              <p className="mt-3 text-gray-300">Higher bandwidth = Lower cost = Preferred path!</p>
            </InfoBox>

            <h2 className="mt-12 mb-6 text-3xl font-bold text-blue-400">Why Manually Set Cost?</h2>
            <p className="mb-4 text-gray-300">Sometimes you want to override the automatic calculation:</p>
            ...
            <div className="my-8 grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border border-green-600 bg-green-900 p-6">
                <h4 className="mb-3 font-semibold text-green-300">Low Cost Interface (Primary)</h4>
                <Diagram variant="success">
                  {`interface g0/0
ip ospf cost 10
...
[✓] Use this first`}
              ...
              <div className="rounded-lg border border-yellow-600 bg-yellow-900 p-6">
                <h4 className="mb-3 font-semibold text-yellow-300">High Cost Interface (Backup)</h4>
                <Diagram>
                  {`interface g0/2
ip ospf cost 30
...
[!] Use if primary fails`}
            ...
            <p className="mb-8 text-lg text-gray-300">Configure OSPF costs on two interfaces to control path preference:</p>
            <ol className="my-8 list-decimal space-y-5 rounded-lg border border-gray-700 bg-gray-800 p-8 pl-12 text-gray-300">
              <li><code>enable</code></li>
              <li><code>configure terminal</code></li>
          ...
          <LessonSection title="Capstone: Full Network Configuration">
            ...
            <div className="my-8 rounded-lg border border-gray-700 bg-gray-800 p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="border-b border-gray-700 pb-4">
                  <h5 className="mb-2 font-semibold text-blue-300">Layer 3 Interfaces (Routed Ports):</h5>
                  <ul className="ml-6 list-disc space-y-1 text-gray-300">
            ...
            <InfoBox variant="real-world">
              <h4 className="mb-3 font-semibold text-blue-300">🎓 What You Just Accomplished</h4>
              <p className="mb-3 text-gray-300">
          ...
          <div className="my-20 rounded-lg border-2 border-green-600 bg-green-900 p-12">
            ...
            <div className="mx-auto mt-10 grid max-w-3xl gap-4 md:grid-cols-2">
              <div className="rounded-lg bg-gray-800 p-4 text-gray-300">✅ CLI navigation and modes</div>
              ...
              <div className="rounded-lg bg-gray-800 p-4 text-gray-300">✅ Password entry experience</div>
              <div className="rounded-lg bg-gray-800 p-4 text-gray-300">✅ Sub-configuration modes</div>
              <div className="rounded-lg bg-gray-800 p-4 text-gray-300">✅ Understanding IP addresses</div>
              <div className="rounded-lg bg-gray-800 p-4 text-gray-300">✅ Network hardware basics</div>
              <div className="rounded-lg bg-gray-800 p-4 text-gray-300">✅ Management access configuration</div>
              <div className="rounded-lg bg-gray-800 p-4 text-gray-300">✅ Creating and organizing VLANs</div>
              <div className="rounded-lg bg-gray-800 p-4 text-gray-300">✅ SVI (VLAN interfaces) for routing</div>
              <div className="rounded-lg bg-gray-800 p-4 text-gray-300">✅ Trunk ports (ALL vs restricted VLANs)</div>
              <div className="rounded-lg bg-gray-800 p-4 text-gray-300">✅ SSH secure access</div>
              <div className="rounded-lg bg-gray-800 p-4 text-gray-300">✅ Layer 3 switching & routed ports</div>
              <div className="rounded-lg bg-gray-800 p-4 text-gray-300">✅ Point-to-point /30 subnets</div>
              <div className="rounded-lg bg-gray-800 p-4 text-gray-300">✅ Static routing with floating backups</div>
              <div className="rounded-lg bg-gray-800 p-4 text-gray-300">✅ OSPF on ALL Layer 3 interfaces</div>
              <div className="rounded-lg bg-gray-800 p-4 text-gray-300">✅ OSPF cost manipulation</div>
            </div>
          </div>
        </div>
        <Footer />

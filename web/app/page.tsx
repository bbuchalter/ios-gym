  ...
  return (
    <div id="top" className="min-h-screen bg-gray-900">
      ...
      <main className="max-w-6xl mx-auto px-6 pb-24">
        <section className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {highlightMetrics.map((metric) => (
            ...
            >
              ...
              <p className="mt-3 text-sm text-gray-400">{metric.detail}</p>
            </div>
          ))}
        </section>
        ...
        <section
          id="curriculum"
          className="mt-20 border border-gray-700 bg-gray-800 rounded-lg p-8"
        >
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {trackHighlights.map((track) => (
              ...
              >
                ...
                <span className="inline-block mt-2 border border-blue-600 bg-blue-900 rounded-full px-3 py-1 text-xs font-semibold uppercase text-blue-300">
                  {track.badge}
                </span>
        ...
        <div id="lessons" className="mt-32 border-t border-gray-700 pt-24">
        {/* INTRODUCTION */}
